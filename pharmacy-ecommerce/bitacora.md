YODADA), antiparasitarios (ALBENDAZOL, MEBENDAZOL, IVERMECTINA, PERMETRINA, TINIDAZOL), otros (HIDROXICLOROQUINA, ORLISTAT, FENTERMINA, METOTREXATO, AC IBANDRONICO, ACETAZOLAMIDA, HIDRALAZINA, NIFEDIPINO, DILTIAZEM, NEBIVOLOL, CARVEDILOL, ISOSORBIDE, ROSUVASTATINA, LOVASTATINA, FENOFIBRATO, GEMFIBROZILO, CIPROFIBRATO, TRIMETAZIDINA, NARATRIPTAN, ELETRIPTAN, FLUNARIZINA, BETAHISTINA, DIFENIDOL, DIMENHIDRINATO, DIFENHIDRAMINA, HIDROXICINA, DOXILAMINA, RUPATADINA, DESLORATADINA, LEVOCETIRIZINA, BENZOCAINA, LIDOCAINA, EUGENOL, NEOMICINA, BACITRACINA, MENTOL, ALCANFOR, EUCALIPTO, SALICILATO DE METILO, ALCOHOL DESNATURALIZADO/ISOPROPILICO, PEROXIDO H, CLORHEXIDINA, CETILPIRIDINIO, TRICLOSAN, FENOL, ALUMBRE, AZUL DE METILENO, SILICONA, MIRISTATO IPP, FLUORURO, FOSFATO SODIO, POTASIO, SODIO, CLORURO SODIO, SAL INGLESA, CARBONATO LITIO, ESZOPICLONA, CLORDIAZEPOXIDO, NAFAZOLINA, OXIMETAZOLINA, XILOMETAZOLINA, DIETILTOLUAMIDA, PROTECTOR SOLAR, ACEITE RICINO, HOJAS SEN, ALOINA, PSYLLIUM, LINAZA, PICOSULFATO, AC HIGADO BACALAO, LEVADURA CERVEZA, STEVIA, SUCRALOSA, MIEL, PALTO, BETAXOLOL, BRIMONIDINA, HOMEOPATICO, FITO BUCAL/ESPASMOLITICO/VENOTONICO/ANTIDIARREICO, LAXANTE NATURAL/ESTIMULANTE, TOPICO RESPIRATORIO, PAPAINA, PAPAVERINA, DIOSMINA+HESPERIDINA, CONDROITINA+GLUCOSAMINA, PARACETAMOL+TRAMADOL, SULFAMETOXAZOL, TRIMETOPRIM, CENTELLA, ITRACONAZOL, VALACICLOVIR, LEVOSULPIRIDA).

**Cobertura final**: 385/385 entries con extras (100%). Cada entrada incluye signos de alarma específicos (rojo en UI), consejos de uso prácticos, clasificación Beers (EVITAR/PRECAUCION/SEGURO para adulto mayor — alineado con criterios AGS 2023), vía de administración, notas embarazo/lactancia, y categoría de receta (venta_directa/simple/retenida/cheque).

**Archivo**: `pharmacy-ecommerce/apps/web/src/lib/drug-info-extras.ts` 666 → 3312 líneas. Sin cambios en `drug-info.ts` (merge automático en `lookupDrugInfo()`).

**Impacto UI**: 858 productos adicionales del catálogo ahora renderizan en `/producto/[slug]` las secciones extra (signos_alarma destacado, ProductFAQ con consejos_uso/signos_alarma, badge Beers en ProfessionalInfo, JSON-LD Drug enriquecido para SEO).

**Verificación**: `scripts/rank-missing-extras.ts` (script auxiliar, eliminado tras uso) → "Entries needing extras: 0 / Total products affected: 0". Build local OK.
...
## 2026-05-13 — UX errores recovery + skeleton producto + sinónimos extras

- **errors recovery (mis-pedidos)**: `mis-pedidos/page.tsx` + `mis-pedidos/[id]/page.tsx` agregan estado `loadError` distinguido (en detalle: `network`/`notfound`). Panel recovery con 3 acciones: Reintentar (solo network), WhatsApp +56 9 9364 9604 (prefilled con order id), Llamar (tel:). Reorder ahora cuenta éxitos/fallos via `Promise.allSettled` y muestra toast si algún item se cayó. Anterior tragaba errores silenciosamente.
- **errors recovery (checkout)**: error genérico (no stock-shortage) muestra grid Reintentar (re-dispara handleSubmit) + Contactar por WhatsApp (con resumen del carrito prefilled). Stock-shortage conserva lista detallada y CTA "Volver al carrito".
- **skeleton producto**: `app/producto/[slug]/loading.tsx` (Next.js convention) renderiza fallback completo (back btn + imagen + badges + tabla info + CTA + price) mientras Server Component carga. Antes flasheaba pantalla en blanco hasta que llegaba Prisma.
