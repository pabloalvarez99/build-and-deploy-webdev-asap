...
import { ShoppingCart, Package, LogIn, LogOut, User as UserIcon, Loader2, MapPin, Phone } from 'lucide-react';
    ...
    <div className="sticky top-0 z-50">
      ...
      <div className="bg-emerald-700 text-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex items-center justify-center sm:justify-between h-9 text-xs">
            {/* Dirección */}
            <a 
              href={mapsUrl}
              target="_blank"
      ...
      <nav className={`transition-all duration-300 ${
        scrolled ? 'bg-white/95 backdrop-blur-md shadow-sm border-b border-slate-200/50' : 'bg-white border-b border-slate-100'
      }`}>
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
