...
```ts
import { useListPharmacies, useGetUserPrescriptions, useCreateRefillOrder, useUpdateUserProfile } from '@dataconnect/generated/react';
// The types of these hooks are available in react/index.d.ts

const { data, isPending, isSuccess, isError, error } = useListPharmacies();

const { data, isPending, isSuccess, isError, error } = useGetUserPrescriptions();

const { data, isPending, isSuccess, isError, error } = useCreateRefillOrder(createRefillOrderVars);
